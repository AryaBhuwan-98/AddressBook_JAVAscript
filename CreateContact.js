...
*/
try {
    let contact1 = new Contact("Dipali", "Sonawane", "Residency", "Hyderabad", "Telangana", 500019, 919087654321, "pragna@gmail.com");
    let contact2 = new Contact("Naresh", "Adla", "Layoutpark", "Hyderabad", "Telangana", 500013, 918706765762, "naresh@gmail.com");
